...
public class Airplane : MonoBehaviour
{
	...
	void Update()
	{
		if (elevator != null && engine._isFlying)
		{
			elevator.targetDeflection = -InputPlaneCrash.singleton.verticalValue; //-Input.GetAxis("Vertical")
		}
		if (aileronLeft != null && engine._isFlying)
		{
			aileronLeft.targetDeflection = -InputPlaneCrash.singleton.horizontalValue; // -Input.GetAxis("Horizontal")
		}
		if (aileronRight != null && engine._isFlying)
		{
			aileronRight.targetDeflection = InputPlaneCrash.singleton.horizontalValue; // Input.GetAxis("Horizontal")
		}
		...
		if (engine != null && engine._isFlying)
		{
